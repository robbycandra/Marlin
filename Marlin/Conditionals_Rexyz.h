...
#else
  #define REXYZ_FW_VERSION ".24" // Change this with each update
#endif
#define REXYZ_DEFAULT_MACHINE_UUID "12345678"
...
#if ENABLED(REXYZ_N2) || ENABLED(REXYZ_N3)
