...
#include "../../../inc/MarlinConfig.h"
  ...
  void unified_bed_leveling::smart_fill_mesh() {
    ...
    void unified_bed_leveling::tilt_mesh_based_on_probed_grid(const bool do_3_pt_leveling) {
      constexpr int16_t x_min = _MAX(zprobe_min_x, MESH_MIN_X),
                        x_max = _MIN(zprobe_max_x, MESH_MAX_X),
                        y_min = _MAX(zprobe_min_y, MESH_MIN_Y),
                        y_max = _MIN(zprobe_max_y, MESH_MAX_Y);
