...
void _lcd_preheat(const int16_t endnum, const int16_t temph, const int16_t tempb, const uint8_t fan) {
  ...
  void menu_preheat_m1() {
    ...
    #if HOTENDS == 1
      #if HAS_HEATED_BED
        ACTION_ITEM_P(PSTR("HotEnd & Bed"), []{ _preheat_both(0, 0); });
        ACTION_ITEM_P(PSTR("HotEnd"), []{ _preheat_end(0, 0); });
      #else
    ...
    #endif // HOTENDS > 1
    #if HAS_HEATED_BED
      ACTION_ITEM_P(PSTR("Bed"), []{ _preheat_bed(0); });
    #endif
    END_MENU();
  }
  ...
  void menu_preheat_m2() {
    ...
    #if HOTENDS == 1
      #if HAS_HEATED_BED
        ACTION_ITEM_P(PSTR("HotEnd & Bed"), []{ _preheat_both(1, 0); });
        ACTION_ITEM_P(PSTR("HotEnd"), []{ _preheat_end(1, 0); });
      #else
    ...
    #endif // HOTENDS > 1
    #if HAS_HEATED_BED
      ACTION_ITEM_P(PSTR("Bed"), []{ _preheat_bed(1); });
    #endif
    END_MENU();
  }
