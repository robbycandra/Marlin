      ...
      if (!printer_busy()) {
        ...
        // Unload filament
          ...
          if (thermalManager.targetHotEnoughToExtrude(active_extruder))
            ...
            SUBMENU14(MSG_FILAMENTUNLOAD, menu_temp_e0_filament_unload);
        #else
          #if ENABLED(FILAMENT_UNLOAD_ALL_EXTRUDERS)
            ...
            SUBMENU14(MSG_FILAMENTUNLOAD_ALL, menu_unload_filament_all_temp);
          #endif
          if (thermalManager.targetHotEnoughToExtrude(0))
            GCODES_ITEM(MSG_FILAMENTUNLOAD " " MSG_E1, PSTR("M702 T0"));
          else
            SUBMENU14(MSG_FILAMENTUNLOAD " " MSG_E1, menu_temp_e0_filament_unload);
          if (thermalManager.targetHotEnoughToExtrude(1))
            GCODES_ITEM(MSG_FILAMENTUNLOAD " " MSG_E2, PSTR("M702 T1"));
          else
            SUBMENU14(MSG_FILAMENTUNLOAD " " MSG_E2, menu_temp_e1_filament_unload);
          #if E_STEPPERS > 2
            if (thermalManager.targetHotEnoughToExtrude(2))
              GCODES_ITEM(MSG_FILAMENTUNLOAD " " MSG_E3, PSTR("M702 T2"));
            else
              SUBMENU14(MSG_FILAMENTUNLOAD " " MSG_E3, menu_temp_e2_filament_unload);
            #if E_STEPPERS > 3
              if (thermalManager.targetHotEnoughToExtrude(3))
                GCODES_ITEM(MSG_FILAMENTUNLOAD " " MSG_E4, PSTR("M702 T3"));
              else
                SUBMENU14(MSG_FILAMENTUNLOAD " " MSG_E4, menu_temp_e3_filament_unload);
              #if E_STEPPERS > 4
                if (thermalManager.targetHotEnoughToExtrude(4))
                  GCODES_ITEM(MSG_FILAMENTUNLOAD " " MSG_E5, PSTR("M702 T4"));
                else
                  SUBMENU14(MSG_FILAMENTUNLOAD " " MSG_E5, menu_temp_e4_filament_unload);
                #if E_STEPPERS > 5
                  if (thermalManager.targetHotEnoughToExtrude(5))
                    GCODES_ITEM(MSG_FILAMENTUNLOAD " " MSG_E6, PSTR("M702 T5"));
                  else
                    SUBMENU14(MSG_FILAMENTUNLOAD " " MSG_E6, menu_temp_e5_filament_unload);
                #endif // E_STEPPERS > 5
              #endif // E_STEPPERS > 4
            #endif // E_STEPPERS > 3
          #endif // E_STEPPERS > 2
