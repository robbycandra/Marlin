...
void menu_advanced_homePos() {
  ...
  void menu_advanced_probe() {
    ...
    _MENU_ITEM_VARIANT_P(float3, _edit, true, PSTR("Probe X Offset"), PSTR("Probe X Offset"),&zprobe_offset[X_AXIS], 0, 30);
    _MENU_ITEM_VARIANT_P(float3, _edit, true, PSTR("Probe Y Offset"), PSTR("Probe Y Offset"),&zprobe_offset[Y_AXIS], -30, 30);
    _MENU_ITEM_VARIANT_P(float52, _edit, true, PSTR("Probe Z Offset"), PSTR("Probe Z Offset"),&zprobe_offset[Z_AXIS], Z_PROBE_OFFSET_RANGE_MIN, Z_PROBE_OFFSET_RANGE_MAX);
    END_MENU();
  }
