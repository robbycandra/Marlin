...
void menu_move() {
  ...
  if (
    ...
    if (active_extruder)
      ...
      #if E_MANUAL == 5
        SUBEDIT(MSG_MOVE_E MSG_MOVE_E5, lcd_move_get_e4_amount);
      #elif E_MANUAL == 3
        SUBEDIT(MSG_MOVE_E MSG_MOVE_E3, lcd_move_get_e2_amount);
      #endif
      ...
      SUBMENUH31(MSG_MOVE_E, lcd_move_get_e_amount);
        ...
        SUBEDIT(MSG_MOVE_E MSG_MOVE_E2, lcd_move_get_e1_amount);
          ...
          SUBEDIT(MSG_MOVE_E MSG_MOVE_E3, lcd_move_get_e2_amount);
          #if E_MANUAL > 3
            SUBEDIT(MSG_MOVE_E MSG_MOVE_E4, lcd_move_get_e3_amount);
            #if E_MANUAL > 4
              SUBEDIT(MSG_MOVE_E MSG_MOVE_E5, lcd_move_get_e4_amount);
              #if E_MANUAL > 5
                SUBEDIT(MSG_MOVE_E MSG_MOVE_E6, lcd_move_get_e5_amount);
              #endif // E_MANUAL > 5
            #endif // E_MANUAL > 4
          #endif // E_MANUAL > 3
        #endif // E_MANUAL > 2
