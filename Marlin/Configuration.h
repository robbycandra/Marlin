...
#define STRING_CONFIG_H_AUTHOR "(Rajawali3D, Rexyz)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT REXYZ_SERIAL_PORT
...
// :[1, 2, 3, 4, 5, 6]
#define EXTRUDERS REXYZ_EXTRUDERS
 ...
 *     5 : 100K thermistor - ATC Semitec 104GT-2/104NT-4-R025H42G (Used in ParCan & J-Head) (4.7k pullup) - Genuine quality ones
 ...
 *    11 : 100k beta 3950 1% thermistor (4.7k pullup) - The ones keenovo uses
...
#if ENABLED(PREVENT_LENGTHY_EXTRUDE) && (REXYZ_FILAMENT_CHANGE_UNLOAD_LENGTH > 200)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   REXYZ_DEFAULT_AXIS_STEPS_PER_UNIT
 ...
 *
 */
#define Z_MIN_PROBE_PIN REXYZ_Z_MIN_PROBE_PIN // Pin 32 is the RAMPS default
 ...
 */
#define PROBE_MANUALLY       REXYZ_PROBE_MANUALLY
#define MANUAL_PROBE_START_Z REXYZ_MANUAL_PROBE_START_Z

/**
 * A Fix-Mounted Probe either doesn't deploy or needs manual deployment.
 *   (e.g., an inductive probe or a nozzle-based probe-switch.)
 */
#define FIX_MOUNTED_PROBE    REXYZ_FIX_MOUNTED_PROBE
 ...
 *   (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER REXYZ_X_PROBE_OFFSET_FROM_EXTRUDER // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER REXYZ_Y_PROBE_OFFSET_FROM_EXTRUDER // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER REXYZ_Z_PROBE_OFFSET_FROM_EXTRUDER // Z offset: -below +above  [the nozzle]

// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE REXYZ_LEVEL_CORNERS_INSET
...
#define PAUSE_BEFORE_DEPLOY_STOW REXYZ_PAUSE_BEFORE_DEPLOY_STOW
#if ENABLED(PAUSE_BEFORE_DEPLOY_STOW)
  #define PAUSE_PROBE_DEPLOY_WHEN_TRIGGERED REXYZ_PAUSE_PROBE_DEPLOY_WHEN_TRIGGERED // For Manual Deploy Allenkey Probe
#endif
...
#define X_BED_SIZE REXYZ_X_BED_SIZE
...
//#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SCRIPT REXYZ_FILAMENT_RUNOUT_SCRIPT
...
#define HOMING_FEEDRATE_Z  REXYZ_HOMING_FEEDRATE_Z
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT             REXYZ_NOZZLE_PARK_POINT
