 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD REXYZ_THERMAL_PROTECTION_PERIOD // Seconds
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD REXYZ_WATCH_TEMP_PERIOD // Seconds
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD REXYZ_THERMAL_PROTECTION_BED_PERIOD // Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD REXYZ_WATCH_BED_TEMP_PERIOD // Seconds
...
#define USE_CONTROLLER_FAN REXYZ_USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED REXYZ_CONTROLLERFAN_SPEED         // 255 == full speed
#endif
 ...
 */
#define E0_AUTO_FAN_PIN REXYZ_E0_AUTO_FAN_PIN
...
#define EXTRUDER_AUTO_FAN_SPEED REXYZ_EXTRUDER_AUTO_FAN_SPEED // 255 == full speed
...
//
#define NUM_Z_STEPPER_DRIVERS REXYZ_NUM_Z_STEPPER_DRIVERS   // (1-4) Z options change based on how many

#if NUM_Z_STEPPER_DRIVERS > 1
  //#define Z_MULTI_ENDSTOPS
  #if ENABLED(Z_MULTI_ENDSTOPS)
    #define Z2_USE_ENDSTOP          REXYZ_Z2_USE_ENDSTOP // _XMAX_
    #define Z2_ENDSTOP_ADJUSTMENT   0
    #if NUM_Z_STEPPER_DRIVERS >= 3
      #define Z3_USE_ENDSTOP        REXYZ_Z3_USE_ENDSTOP // _YMAX_
      #define Z3_ENDSTOP_ADJUSTMENT 0
    #endif
    #if NUM_Z_STEPPER_DRIVERS >= 4
      #define Z4_USE_ENDSTOP        REXYZ_Z4_USE_ENDSTOP // _ZMAX_
...
//#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_10X_STEPS_PER_SEC  REXYZ_ENCODER_10X_STEPS_PER_SEC   // (steps/s) Encoder rate for 10x speed
  #define ENCODER_100X_STEPS_PER_SEC REXYZ_ENCODER_100X_STEPS_PER_SEC  // (steps/s) Encoder rate for 100x speed
#endif
...
#define LCD_SHOW_E_TOTAL
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    REXYZ_SDSORT_USES_RAM  // Pre-allocate a static array for faster pre-sorting.
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES REXYZ_SDSORT_CACHE_NAMES  // Keep sorted items in RAM longer for speedy performance. Most expensive option.
...
// BUFSIZE 4 suka error saat akhir printing dengan line yg panjang
#define BUFSIZE 8
 ...
 * 3. Delay   FILAMENT_UNLOAD_PURGE_DELAY
...
// Mengatasi filament stuck, maka dibuat unload lebih panas dan lebih cepat
  ...
  #define FILAMENT_UNLOAD_FIRST_PURGE_LENGTH   5  // (mm) Unload initial purge length.
