...
custom_ld_script = os.path.abspath("buildroot/share/PlatformIO/ldscripts/rexyz_with_40K_bootloader.ld")
...
def addboot(source,target,env):
	...
	bootloader_dir = "buildroot/share/PlatformIO/scripts/rexyz_40K_bootLoader.bin"
	bootloader = open(bootloader_dir, "rb")
	lengthbootloader = os.path.getsize(bootloader_dir)
	firmware_with_boothloader_dir = target[0].dir.path +'/rexyz_firmware_with_40K_bootloader.bin'
	...
	os.rename(target[0].path, firmware_without_bootloader_dir)	#os.rename(target[0].dir.path+'/rexyz_firmware_with_40K_bootloader.bin', target[0].dir.path+'/firmware.bin')
